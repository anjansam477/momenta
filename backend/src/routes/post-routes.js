...
const { authorizePost, validateWall, checkArchive, authorizePostAction, authorizeUnreportPost } = require("../middleware/post-validations");
...
router.post("/:wallId/posts",                  verifyToken, authorizePostAction, validateWall, upload.single("file"), postsController.createPost);
...
router.post("/:wallId/posts/:postId/react/:reactionType",   verifyToken, authorizePost, validateWall, postsController.addReaction);
